...
<main class="d-flex">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 d-inline bg-light" style="width: 280px;">
    ...
    <ul class="nav flex-column mb-auto">
      <li class="nav-item">
        <a href="/profile" class="nav-link " style="background-color: #AA8B56; color:#fff;" aria-current="page">
  ...
  <div class="g-5 d-flex justify-content-center">
    <div class="col-md-7 col-lg-8">
      <form class="needs-validation" action="index.php?act=profile" method="post">
        <div class="row g-3">
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="input-group has-validation">
              ...
              <input type="text" class="form-control" id="username" name="user" value="<?= $user ?>" placeholder="Username" required>
              <div class="invalid-feedback">
          ...
          <div class="col-12">
            ...
            <input type="text" class="form-control" id="phone" name="phone" value="<?= $phone_number ?>" placeholder="+84" required>
            <div class="invalid-feedback">
          ...
          <div class="col-12">
            ...
            <input type="text" value="<?= $address ?>" name="address" class="form-control" id="bill_ad" required>
            <div class="invalid-feedback">
              Please enter your shipping address.
            </div>
          </div>
          ...
          <input class="w-100 btn btn-lg" type="submit" name="account" value="Account update" style="background-color: #AA8B56;color:#fff">
      </form>
    </div>
  </div>
  </div>
