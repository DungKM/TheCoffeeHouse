    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="row">
                    <?php foreach ($list_top6_products as $list) :  ?>
                            ...
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    <ul>
                                        ...
                                        <li><i class="fa fa-comment-o"></i>Quality food</li>
                                    </ul>
                                    <h5><a href="#"></a><?= $list->name_pro ?></h5>
                                    <p class="oksu" style="height: 100px;overflow-y: scroll;border-radius:0px"> <?= $list->describe ?></p>
